...
### Add New Simulation
1. Create file: `src/test/scala/com/example/simulations/MySimulation.scala`
2. Extend `Simulation` class
3. Run with Maven: `mvn gatling:test`
...
│   │   ├── GoogleHomepageSimulation.scala
│   │   ├── GoogleSearchSimulation.scala
│   │   └── GoogleStressSimulation.scala
│   └── resources/
│       └── gatling.conf
└── target/
