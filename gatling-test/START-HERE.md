...
Edit `src/test/scala/com/example/simulations/GoogleHomepageSimulation.scala`
...
│
└── src/test/scala/com/example/simulations/
    ├── GoogleHomepageSimulation.scala       ← Homepage test
    ├── GoogleSearchSimulation.scala         ← Search test
    └── GoogleStressSimulation.scala         ← Stress test
```
...
| `QUICKSTART.md` | Getting started guide |
| Simulation .scala files | The actual test scripts |
